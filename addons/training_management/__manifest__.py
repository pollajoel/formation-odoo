# -*- coding: utf-8 -*-
{
    ...
    'auto_install': False,
    'depends': ['base', 'account', 'contacts', 'sale_management', 'product', 'mail', 'digest'],
    'data': [
        ...
        'views/ir.cron/ir_cron_process_paid_orders.xml',
        'views/digest_views.xml',
        'views/wizards/add_trainee_wizard_view.xml',
        'demo/res_company.demo.xml',
    ...
    'assets':{
        "web.assets_backend" : [
            "training_management/static/src/js/services/*.js",
            "training_management/static/src/js/*.js",
            "training_management/static/src/js/session/*.js",
            "training_management/static/src/js/registration/*.js",
